...
void NetworkControl::ClientGetHttpFunc() {
    ...
    http_server_.Get("/rxx/GetPose", std::bind(&NetworkControl::GetPose, this, std::placeholders::_1, std::placeholders::_2));
    http_server_.Get("/rxx/ShowPose", std::bind(&NetworkControl::ShowPose, this, std::placeholders::_1, std::placeholders::_2));
}
...
void NetworkControl::FileDownload(const httplib::Request& req, httplib::Response& resp) {
    ...
    nlohmann::json json_info = {{"data", {{"models", models_json_root}}}};
...
void NetworkControl::QueryModelWithUid(const httplib::Request& req, httplib::Response& resp) {
    ...
    nlohmann::json json_resp = {{"data", {{"models", data_2_resp}}}};
...
void NetworkControl::ShowPose(const httplib::Request& req, httplib::Response& resp) {
    if (req.body.empty()) {
        return;
    }

    nlohmann::json req_info = nlohmann::json::parse(req.body);
...
bool NetworkControl::test() {
    ...
    pose_list.push_back("x,y,z,r,p,y");
    nlohmann::json json_obj = {{"name", "cellphone"}, {"uid", "223fds1240"}, {"pose", pose_list}, {"content_base64", b64_obj}};
...
bool NetworkControl::DownloadDbPose2Disk(std::string id, std::string name, nlohmann::json doc) {
    ...
    nlohmann::json json_pose = {"pose", doc["pose"]};
